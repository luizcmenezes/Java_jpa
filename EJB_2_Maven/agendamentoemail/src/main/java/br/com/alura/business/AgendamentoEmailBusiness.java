...
public class AgendamentoEmailBusiness {
    ...
    private static String EMAIL_FROM = "6cbd75d1c1-b5c537@inbox.mailtrap.io";
    private static String EMAIL_USER = "ff68c6b94bea39";
    private static String EMAIL_PASSWORD = "49d2e54aba2f34";
