...
public class TestaRelacionamentoMovimentacaoCategoria {
	public static void main(String[] args) {
		...
		movimentacao.setDescriscao("Viagem à São Paulo");
		movimentacao.setTipoMvimentacao(TipoMovimentacao.SAIDA);
		...
		movimentacao2.setDescriscao("Viagem ao Rio de Janeiro");
		movimentacao2.setTipoMvimentacao(TipoMovimentacao.SAIDA);
